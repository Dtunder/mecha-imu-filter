...
from filters import ComplementaryFilter, KalmanFilter, LowPassFilter
...
class TestFilters(unittest.TestCase):
    ...
    def test_validation(self) -> None:
        ...
        with self.assertLogs("filters", level="ERROR") as cm:
            with self.assertRaises(TypeError):
                KalmanFilter(initial_value="0.0")  # type: ignore
    ...
    def test_kalman_zero_division(self) -> None:
    ...
    def test_kalman_filter(self) -> None:
        ...
        self.assertAlmostEqual(
            val1, 9.9, places=1
        )  # The first update won't perfectly reach 10 due to noise config
